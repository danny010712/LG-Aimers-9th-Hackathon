...
- 순위 (2026-08-13): 우리 **998.003 = 197위**(제출 27회). 950.96=252위에서 상승. 이전 팀 최고 908.39(257위).
  **1위 1295.47**(제출 11회) / 2위 1228.80 / 3위 1157.18 / 10위 1135.18 / **100위 1059.12**.
  → **100위까지 +61.1** (전날 +48.3 → 우리가 멈춘 사이 컷이 +12.8 올랐다).
  Brier 환산: 우리 .24743 / 100위 .24719(**차이 .00024**) / 1위 .24691(차이 .00052).
  ⚠️ **상위 2명 이탈**: 전날 1위 1156.21 → 1295.47(+139). 3위와 138 차 = **모르는 축 하나 보유.**
  반면 3~10위는 1135~1157 밀집(폭 22, 전날 1127~1156에서 +8만). 그 벽은 그대로다.
